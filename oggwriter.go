...
func (i *OggWriter) WritePacket(packet []byte, timestamp uint32) error {
	if len(packet) == 0 {
		return nil
	}
	...
	data := i.createPage(packet, pageHeaderTypeContinuationOfStream, i.previousGranulePosition, i.pageIndex)
	i.pageIndex++
